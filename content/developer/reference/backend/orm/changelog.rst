...
Populate command?
papermuncher?
removing requests from model? (maybe not needed here)
cache on transaction? (probably after freeze)
...
- New HTTP server in `#247162 <https://github.com/odoo/odoo/pull/247162>`.
- ``expr_eval`` for simple expressions.
  See `#255216 <https://github.com/odoo/odoo/pull/255216>`_.
- Tables start at a random ID for testing.
  See `#248661 <https://github.com/odoo/odoo/pull/248661>`_.
